...
class SUI:
    ...
    def action_keepsake(self):
        ...
        time.sleep(1)
        self.wait.until(EC.presence_of_element_located((By.XPATH, f'//*[@id="react-tabs-1"]/ul[1]/li[4]/a'))).click() #tab2
        time.sleep(1)

        time.sleep(1)
        self.wait.until(EC.presence_of_element_located((By.XPATH, f'//*[@id="react-tabs-1"]/div[2]/div[1]/div/div[1]/div[2]/button'))).click() #  explore
        time.sleep(1)
        self.wait.until(EC.presence_of_element_located((By.XPATH, f'/html/body/div[3]/div/div/div[2]/button'))).click() #tab2
        time.sleep(1)
        self.wait.until(EC.number_of_windows_to_be(self.number_tab + 1))
        handles = self.driver.window_handles
        current_handle = handles[-1]
